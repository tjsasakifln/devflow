...
/** @deprecated Use EvidenceRef from kernel/evidence/schema.ts instead. */
...
export interface StateDetectionResult {
  ...
  /** @deprecated Use evidenceChain instead. */
  evidence: Evidence[];
  /** Structured evidence chain with hashes, sources, and traceability. */
