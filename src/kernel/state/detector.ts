...
import { gatherEvidence, gatherEvidenceRefs } from "../evidence/gatherer.js";
import { scoreConfidence } from "../evidence/confidence.js";
...
export async function detectState(
  ...
  const evidenceChain = gatherEvidenceRefs(inspection);
