...
export const TRANSITION_TABLE: Record<DevflowState, DevflowState[]> = {
  ...
  "feature-requirements-audited": ["feature-planning"],
  ...
  "drift-detected": ["blocked", "feature-empty", "feature-validation"],
...
export const ACTION_MAP: Record<DevflowState, NextActionEntry> = {
  ...
  "feature-clarification-needed": {
    ...
    targetStates: ["feature-requirements-audited", "feature-requirements"],
    primaryAction: {
      id: "resolve-doubts",
      description:
