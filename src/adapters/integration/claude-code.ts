...
import { MARKER_START, MARKER_END } from "../../kernel/utils/markdown.js";
...
| **Adversarial Reviewer** | Tenta rejeitar a feature: 12 vetores de ataque | Não |
...
6. **Adversarial Review:** \`devflow adversarial-review <id>\` — tentar rejeitar a feature
7. **Review:** gatekeeper aprova → \`devflow feature complete\`
